...
main = tkinter.Tk()
main.title("CANCER CLASSIFICATION USING CT/MRI IMAGES BASED ON LEARNING WITHOUT FORGETTING POWERED DEEP LEARNING MODELS")
...
font = ('times', 14, 'bold')
title = Label(main, text='CANCER CLASSIFICATION USING CT/MRI IMAGES BASED ON LEARNING WITHOUT FORGETTING POWERED DEEP LEARNING MODELS')
